var app = angular.module('coeplimApp.cosechaAnualCtrl', []);

	app.controller('cosechaAnualCtrl', ['$scope','$http', 'Cosecha', function($scope,$http,Cosecha){
      ...
      //validar que parcela este seleccionada
					...
					if ($scope.info.year != undefined) {
						...
						Cosecha.repCosechaAnual(info).then(function(){
